...
const seed = [
  ...
  {
    name: "Xote dos Milagres - Falamansa",
    youtubeLink: "https://www.youtube.com/watch?v=ZTDStzSs2Wo",
  },
  {
    name: "Alceu Valença - La Belle de Jour / Girassol (Ao Vivo)",
    youtubeLink: "https://www.youtube.com/watch?v=l-FxY25lYzY",
  },
  {
  ...
  {
    name: "Raça Negra - Cheia de Manias part. Thiaguinho",
    youtubeLink: "https://www.youtube.com/watch?v=lxNd6LRi-PQ",
  },
];
...
describe("GET /recommendations", () => {
  ...
  it("Buscando recomendações pelo ID, esperando return 200", async () => {
    ...
    const findId = await prisma.recommendation.findFirst({
      where: { name: "Falamansa - Xote da Alegria" },
    });
